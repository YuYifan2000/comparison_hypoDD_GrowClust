...
for i in range(0, len(o_sources)):
	...
	f.write(f"# 2000 12 13 15 00 1.00 {random_lat:6.3f} {random_lon:6.3f} {sources[i][2]:5.2f} 1 0 0 0 {i} \n")
	f2.write(f"# 2000 12 13 15 00 1.00 {o_sources[i][0]:5.3f} {o_sources[i][1]:6.3f} {sources[i][2]:5.2f} 1 0 0 0 {i} \n")
	st = time.time()
