...
ax.scatter(sources[:,0], sources[:,1], sources[:,2], zdir='z', marker = "*", c='blue', s=2.5)
ax.scatter(catalog_dd["LAT"], catalog_dd["LON"], catalog_dd["DEPTH"], zdir="z", marker="*", c="red", s=2.5)
#ax.scatter(catalog_vele["LAT"], catalog_vele["LON"], catalog_vele["DEPTH"], zdir="z", marker="*", c="red", s=2.5)
#ax.legend()
